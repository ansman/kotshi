...
inline fun CodeBlock.Builder.addControlFlow(controlFlow: String,
                                            vararg args: Any,
                                            close: Boolean = true,
...
inline fun CodeBlock.Builder.addNextControlFlow(controlFlow: String,
                                                vararg args: Any,
                                                close: Boolean = true,
                                                block: CodeBlock.Builder.() -> Unit): CodeBlock.Builder {
 ...
 */
inline fun CodeBlock.Builder.addSwitchBranch(branch: String,
                                             vararg args: Any,
                                             block: CodeBlock.Builder.() -> Unit): CodeBlock.Builder {
